...
*Bertelsmann Stiftung Data: Digital Health Index

gen DHI=28.52 if country=="Poland"
replace DHI=30.02 if country=="Germany"
replace DHI=31.61 if country=="France"
replace DHI=40.62 if country=="Switzerland"
replace DHI=54.67 if country=="Belgium"
replace DHI=55.81 if country=="Italy"
replace DHI=57.31 if country=="Australia"
replace DHI=59.81 if country=="Austria"
replace DHI=66.05 if country=="Netherlands"
replace DHI=67.19 if country=="Portugal"
replace DHI=68.26 if country=="Sweden"
replace DHI=69.98 if country=="United Kingdom"
replace DHI=71.36 if country=="Spain"
replace DHI=72.45 if country=="Israel"
replace DHI=72.47 if country=="Denmark"
replace DHI=74.73 if country=="Canada"
replace DHI=81.92 if country=="Estonia"

label var DHI "Digital Health Index, Bertelsmann Stiftung 2019"
...
*==============================================================================*
*Growth rate in health expenditure
gen h_growth = ln(h_exp)-ln(l.h_exp)
...
*==============================================================================*
*Based on DHI
*Digital Health Index, Bertelsmann Stiftung 2019

label var ict_share "ICT Share"
label var DHI "Digital Health Index"

*Linear model
reg DHI ict_share
predict Fit

twoway(scatter DHI ict_share if year==2019, mlabel(code) mlabs(tiny) mlabp(12))(line Fit ict_share if ict_share<10)


*==============================================================================*
*Comparison ASEAN and other countries
*==============================================================================*
sum gdp_g ict_share if ASEAN==1
sum gdp_g ict_share if ASEAN==0
